...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  color: #d19a66;
        ...
        <body class='markdown-preview' data-use-github-style><h1 id="what-i-hope-to-learn-in-info-201">What I hope to learn in Info 201</h1>
<p>Through distance learning I hope to learn:</p>
<ul>
<li><strong>coding</strong></li>
<li><strong>new coding resources</strong></li>
